...
# Configuration Script – EHC 1.09 - Rev. A

This **Configuration** script is designed for the **EHC 1.09** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EHC 1.09 Rev. A

Este script de **Configuration** está diseñado para el modelo **EHC 1.09** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
